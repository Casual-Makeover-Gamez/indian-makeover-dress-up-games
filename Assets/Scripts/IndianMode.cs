...
[System.Serializable]
public enum IndianSelectedItem
{
     Dress, Hair, EyeShades, EyeBrow, Blush, Lipstick, HairBand, EarRings, NeckLace, Bangels, HandItems, Shoes, BackGround
}
public class IndianMode : MonoBehaviour
{
    public IndianSelectedItem selectedItem;
    public IndianUiElements uIElements;
    public IndianOpponent oppElements;
    [Header("Panels")]
    ...
    private void Start()
    {
        ...
        selectedItem = IndianSelectedItem.Dress;
    ...
    public void SelectedCatagory(int index)
    {
        ...
        if (index == (int)IndianSelectedItem.Dress)
        {
            selectedItem = IndianSelectedItem.Dress;
            uIElements.dressScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.Hair)
        {
            selectedItem = IndianSelectedItem.Hair;
            uIElements.hairScrolleer.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.Bangels)
        {
            selectedItem = IndianSelectedItem.Bangels;
            uIElements.BangelsScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.HairBand)
        {
            selectedItem = IndianSelectedItem.HairBand;
            uIElements.HairBandScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.EarRings)
        {
            selectedItem = IndianSelectedItem.EarRings;
            uIElements.earRingScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.Blush)
        {
            selectedItem = IndianSelectedItem.Blush;
            uIElements.BlushScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.HandItems)
        {
            selectedItem = IndianSelectedItem.HandItems;
            uIElements.HandItemsScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);

        }
        else if (index == (int)IndianSelectedItem.EyeShades)
        {
            selectedItem = IndianSelectedItem.EyeShades;
            uIElements.EyeShadesScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.Lipstick)
        {
            selectedItem = IndianSelectedItem.Lipstick;
            uIElements.lipstickScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)IndianSelectedItem.NeckLace)
        {
            selectedItem = IndianSelectedItem.NeckLace;
            uIElements.necklaceScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)IndianSelectedItem.EyeBrow)
        {
            selectedItem = IndianSelectedItem.EyeBrow;
            uIElements.EyeBrowScroller.SetActive(true);
            CharactorMover.Move(new Vector3(50, -450, -900), 0.5f, true, false);

        }
        else if (index == (int)IndianSelectedItem.Shoes)
        {
            selectedItem = IndianSelectedItem.Shoes;
            uIElements.shoeScroller.SetActive(true);
            CharactorMover.Move(new Vector3(100, -150, 200), 0.5f, true, false);
        }
        else if (index == (int)IndianSelectedItem.BackGround)
        {
            selectedItem = IndianSelectedItem.BackGround;
    ...
    {
        if (selectedItem == IndianSelectedItem.Dress)
        {
            SetItemsInfo(dressList, DressScore);
        }
        else if (selectedItem == IndianSelectedItem.HandItems)
        {
            SetItemsInfo(HandItemList, HandItemScore);
        }
        else if (selectedItem == IndianSelectedItem.HairBand)
        {
            SetItemsInfo(HairBandList, HairBandScore);
        }
        else if (selectedItem == IndianSelectedItem.Hair)
        {
            SetItemsInfo(hairList, HairScore);
        }
        else if (selectedItem == IndianSelectedItem.Bangels)
        {
            SetItemsInfo(BangelsList, BangelsScore);
        }
        else if (selectedItem == IndianSelectedItem.Shoes)
        {
            SetItemsInfo(ShoesList, ShoesScore);
        }
        else if (selectedItem == IndianSelectedItem.EarRings)
        {
            SetItemsInfo(earRingsList, EarRingsScore);
        }
        else if (selectedItem == IndianSelectedItem.EyeShades)
        {
            SetItemsInfo(EyeShadesList, EyeShadesScore);
        }     
        else if (selectedItem == IndianSelectedItem.Lipstick)
        {
            SetItemsInfo(lipstickList, LipstickScore);
        }
        else if (selectedItem == IndianSelectedItem.NeckLace)
        {
            SetItemsInfo(neckLaceList, NeckLaceScore);
        }
        else if (selectedItem == IndianSelectedItem.BackGround)
        {
            SetItemsInfo(backgroundList, BGScore);
        }
        else if (selectedItem == IndianSelectedItem.EyeBrow)
        {
            SetItemsInfo(EyeBrowList, EyeBrowScore);
        }
        else if (selectedItem == IndianSelectedItem.Blush)
        {
